...
export function ShinyButton({ 
  ...
  const colorMap = {
    gold: {
      bg: '#C9952A',
      highlight: '#E8B84B',
      highlightSubtle: '#f0c978',
    },
    teal: {
      bg: '#1a6b6b',
      highlight: '#2d9d9d',
      highlightSubtle: '#52bfbf',
    },
    rose: {
      bg: '#c41e3a',
      highlight: '#e8597b',
      highlightSubtle: '#f08fa3',
    },
  }
  ...
  return (
    <>
      <style jsx>{`
        ...
        .shiny-cta {
          --shiny-cta-bg: ${colors.bg};
          --shiny-cta-bg-subtle: ${colors.bg}dd;
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: ${colors.highlight};
      ...
      <button 
        ...
        {...props}
      >
        <span>{loading ? (variant === 'gold' ? 'Saving…' : variant === 'primary' ? 'Sending…' : 'Loading…') : children}</span>
      </button>
    </>
  )
}
